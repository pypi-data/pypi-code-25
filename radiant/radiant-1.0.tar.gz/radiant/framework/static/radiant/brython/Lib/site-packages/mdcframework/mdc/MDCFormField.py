...
class MDCForm(MDCTemplate):
    ...
    #----------------------------------------------------------------------
    def __new__(self, separator=None, formfield=None, **kwargs):
        """"""
    ...
    #----------------------------------------------------------------------
    @classmethod
    def __genericElement__(cls, Element, extern_label, *args, **kwargs):
        """"""
        if cls.formfield:
    ...
    #----------------------------------------------------------------------
    @classmethod
    def Checkbox(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCCheckbox, True, *args, **kwargs)
        return el


    #----------------------------------------------------------------------
    @classmethod
    def Radio(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCRadio, True, *args, **kwargs)
        return el
    ...
    def Select(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCSelect, False, *args, **kwargs)
        return el
    ...
    def Slider(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCSlider, False, *args, **kwargs)
        return el
    ...
    def Switch(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCSwitch, True, *args, **kwargs)
        return el
    ...
    def TextField(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCTextField, False, *args, **kwargs)
    ...
    #----------------------------------------------------------------------
    @classmethod
    def TextAreaField(cls, *args, **kwargs):
        """"""
        el, element = cls.__genericElement__(MDCTextAreaField, False, *args, **kwargs)
        element.style = {'display': 'flow-root'}
...
class MDCSelect(MDCTemplate):
    ...
    #----------------------------------------------------------------------
    @classmethod
    def add_option(cls, label, value, selected=False, disabled=False):
        """"""
    ...
    #----------------------------------------------------------------------
    @classmethod
    def add_options(cls, options, selected=None):
        """"""
        if selected is None:
            cls.add_option('', '', selected=True)
        else:
            cls['label'].class_name += ' mdc-floating-label--float-above'

        for option in options:
            cls.add_option(*option, option[1] == selected)
