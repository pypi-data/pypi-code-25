...
class MDCLinearProgress(MDCTemplate):
    ...
    def __html__(cls, **context):
        ...
        code = """
            <div role="progressbar" class="mdc-linear-progress {indeterminate} {reversed}">
    ...
    #----------------------------------------------------------------------
    @classmethod
    def set_progress(cls, val, buffer=None):
        """"""
